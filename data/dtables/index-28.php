 ...
 */
        var rbdColumns =  [
            ...
            {"data": "uniq_id", "orderable": false, "searchable": false, "visible": false},
...
*/
            ...
            $('#tbl-uds thead tr:eq(1) th').each( function (i) {
                ...
                if ((table.settings()[0].aoColumns[i].bSearchable == true) && (i > 0)) {
                    var title = $(this).text().trim();
                    $(this).html('<input type="text" style="font-weight: bold; font-size:small; width: 100%;" class="col-search-input" placeholder="Поиск... '/* + title*/ + '"/>');
...
<body>
     <div class="datatable-container dt-bootsrap4" style="margin-left:1%; width:98%;">
